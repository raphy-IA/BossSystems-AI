  ...
  <section className="py-24 bg-white relative overflow-hidden">
    ...
    <div className="container mx-auto px-6 relative z-10">
      <div className="text-center mb-16">
        <h2 className="text-3xl md:text-5xl font-bold text-[#0A1931] mb-6 tracking-tight">Pourquoi choisir Boss Systems AI ?</h2>
        <div className="w-24 h-1 bg-[#D4AF37] mx-auto mb-8" />
        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Chez BOSS SYSTEMS AI, nous accompagnons les entreprises ambitieuses dans leur transformation digitale. Notre approche combine expertise technique, vision stratégique et une obsession pour les résultats concrets.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:border-[#D4AF37]/30 transition-all group">
          ...
          <h3 className="text-2xl font-bold text-[#0A1931] mb-4">Audit & ROI immédiat</h3>
          <p className="text-gray-600 leading-relaxed text-lg">Nous identifions rapidement les leviers de croissance et de sécurité pour un impact mesurable dès les premières semaines.</p>
        </div>
        <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:border-[#D4AF37]/30 transition-all group">
          <div className="w-14 h-14 bg-[#0A1931] text-[#D4AF37] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <h3 className="text-2xl font-bold text-[#0A1931] mb-4">Personnalisation métier</h3>
          <p className="text-gray-600 leading-relaxed text-lg">Pas de solution générique. Nos outils sont taillés sur mesure pour vos défis sectoriels (Audit, Agro, PME, Fintech).</p>
        </div>
        <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:border-[#D4AF37]/30 transition-all group">
          <div className="w-14 h-14 bg-[#0A1931] text-[#D4AF37] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
          </div>
          <h3 className="text-2xl font-bold text-[#0A1931] mb-4">Partenaire Global</h3>
          <p className="text-gray-600 leading-relaxed text-lg">Relation de confiance long-terme, accompagnement au changement et support continu pour vos équipes.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div className="container mx-auto px-6">
      <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
        <div className="text-left">
          <h2 className="text-3xl md:text-5xl font-bold text-[#0A1931] mb-4 tracking-tight">Nos Expertises</h2>
          <p className="text-xl text-gray-600 max-w-2xl">Explorer nos domaines de spécialisation pour propulser votre performance numérique.</p>
        </div>
        <Link to="/services" className="text-[#D4AF37] font-bold text-lg hover:underline flex items-center gap-2">
          Voir tout le hub &rarr;
        </Link>
      </div>
...
const PackagesSection: React.FC = () => (
  <section className="py-24 bg-[#0A1931] text-white relative overflow-hidden">
    ...
    <div className="container mx-auto px-6 text-center relative z-10">
      <h2 className="text-3xl md:text-5xl font-bold mb-6 tracking-tight">Nos Offres Packagées</h2>
      <p className="text-xl text-gray-400 mb-16 max-w-2xl mx-auto">Des solutions prêtes à l'emploi pour accélérer votre croissance digitale en toute simplicité.</p>
...
const SocialProofSection: React.FC = () => (
  <section className="py-24 bg-white">
    <div className="container mx-auto px-6 text-center">
      <h2 className="text-3xl md:text-5xl font-bold text-[#0A1931] mb-16 tracking-tight">Un impact réel sur votre business</h2>
  ...
  <section className="py-24 bg-gray-50 relative">
    <div className="container mx-auto px-6">
      <div className="max-w-3xl mx-auto text-center mb-16">
        <h2 className="text-3xl md:text-5xl font-bold text-[#0A1931] mb-6 tracking-tight">Prenez le tournant de l'IA</h2>
        <p className="text-xl text-gray-600 leading-relaxed">
          Décrivez-nous vos défis. Nos experts analysent votre situation et vous proposent une feuille de route gratuite.
        </p>
      </div>
